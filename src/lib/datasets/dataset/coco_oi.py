...
class COCO_OpenImages(data.Dataset):
  num_classes = 96
  ...
  def __init__(self, opt, split):
    super(COCO_OpenImages, self).__init__()
    self.data_dir = os.path.join(opt.data_dir, 'coco_oi')
    ...
    self.class_name = [
      ...
      'scissors', 'teddy bear', 'hair drier', 'toothbrush', 'one-piece dress',
      't-shirt', 'trousers', 'shorts', 'skirt', 'slipper', 'high heel', 'earrings',
      'belt', 'headphone', 'camera', 'pasta', 'coconut', 'blender', 'coffeemaker',
      'tablet']
    self._valid_ids = [
