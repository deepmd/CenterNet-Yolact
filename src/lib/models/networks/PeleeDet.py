...
class PeleeDet(nn.Module):
    def __init__(self, heads, head_conv):
        self.heads = heads
        self.deconv_with_bias = False

        super(PeleeDet, self).__init__()
        self.bbon = PeleeNet()
        self.inplanes = 704
...
def get_pelee_det(num_layers, heads, head_conv=256, freeze=None):
    model = PeleeDet(heads, head_conv=head_conv)
